...
ProfileModel profileModel = ProfileModel(
  ...
  summary: 'Computer Science student with a strong technical foundation in C++, Object-Oriented'
...
'  problem-solving abilities',
  lastProjects: [
    ...
    'description':'o Develop a cross-platform mobile application using Flutter and Dart.Built a simple interactive game using Java.Built a simple interactive game using Java.Built a simple interactive game using Java.Built a simple interactive game using Java.'
  },
  {
  'title':'Java Game Project – Catch the Ball',
  'description':'Built a simple interactive game using Java.Built a simple interactive game using Java.Built a simple interactive game using Java.Built a simple interactive game using Java.'
